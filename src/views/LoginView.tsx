      ...
      <div className="w-full max-w-[440px] z-10">
        <div className="flex flex-col items-center mb-8">
          <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center shadow-xl mb-6">
            <span className="material-symbols-outlined text-primary text-[36px]">medical_services</span>
          </div>
          <h1 className="text-white text-3xl font-black tracking-tight">MedSys<span className="text-primary">.Pro</span></h1>
        </div>

        <div className="bg-white rounded-[2.5rem] p-8 sm:p-10 shadow-2xl transition-all duration-300">
          <div className="text-center mb-8">
            <h2 className="text-slate-900 text-xl font-bold">{isRegistering ? 'Nova Conta Profissional' : 'Acesso ao Painel'}</h2>
            <p className="text-slate-500 text-sm mt-1">{isRegistering ? 'Cadastre seu nome e e-mail para começar.' : 'Insira suas credenciais para continuar.'}</p>
          </div>
