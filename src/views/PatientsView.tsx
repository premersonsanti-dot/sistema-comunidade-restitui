...
import { Patient, Prescription, Evolution, Profile, Clinic } from '../types';
...
interface PatientsViewProps {
  ...
  onAddPatient: (patient: Omit<Patient, 'id' | 'clinic_id'>) => void;
  ...
  onSaveEvolution: (evolution: Omit<Evolution, 'id' | 'clinic_id'>) => void;
